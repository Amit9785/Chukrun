...
func mapPriorityToInt(priority PriorityClass) int32 {
	switch priority {
...
func mapIntToPriority(val int32) PriorityClass {
	switch val {
	case 4:
	...
	case 0:
		return PriorityClassBackground
	default:
		return PriorityClassNormal
	}
}
