...
func (m *testMockProvider) Execute(ctx context.Context, request *ExecutionRequest) (*ExecutionResult, error) {
	return nil, nil
}

func (m *testMockProvider) Stream(ctx context.Context, request *ExecutionRequest) (<-chan StreamChunk, error) {
	return nil, nil
}
