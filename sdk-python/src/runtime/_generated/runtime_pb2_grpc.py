...
class RuntimeServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Stream = channel.unary_stream(
                '/runtime.RuntimeService/Stream',
                request_serializer=runtime__pb2.ExecuteRequest.SerializeToString,
                response_deserializer=runtime__pb2.StreamChunk.FromString,
                _registered_method=True)
        self.Health = channel.unary_unary(
                '/runtime.RuntimeService/Health',
...
def add_RuntimeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Stream': grpc.unary_stream_rpc_method_handler(
                    servicer.Stream,
                    request_deserializer=runtime__pb2.ExecuteRequest.FromString,
                    response_serializer=runtime__pb2.StreamChunk.SerializeToString,
            ),
...
class RuntimeService:
    ...
    def Stream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/runtime.RuntimeService/Stream',
            runtime__pb2.ExecuteRequest.SerializeToString,
            runtime__pb2.StreamChunk.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
